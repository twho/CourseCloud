...
public class ChatBubbleActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		buttonSend = (Button) findViewById(R.id.chat_activity_btn_send);

		listView = (ListView) findViewById(R.id.activity_rate_listView1);

		chatArrayAdapter = new ChatArrayAdapter(getApplicationContext(),
				R.layout.activity_chat_singlemessage);
		listView.setAdapter(chatArrayAdapter);

		chatText = (EditText) findViewById(R.id.chat_activity_editText_msg);
